...
import { cancelAdminOrder, useAdminEvents, useAdminOrders } from '../../api/admin';
...
export default function AdminFinanceReport() {
  ...
  if (isOrdersLoading || isEventsLoading) {
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            All bookings with delegate lists and finance totals.
          </p>
        </div>
      </div>
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y">
              {sortedOrders.map((order) => {
                ...
                const eventTitle = eventTitleById.get(order.event_id) ?? 'Unknown event';
                ...
                return (
                  <tr key={order.id} className="align-top">
                    <td className="px-4 py-3">
                      ...
                      <div className="text-xs text-gray-500">{eventTitle}</div>
                      ...
                      <Link
                        ...
                        className="inline-block mt-2 text-indigo-600 hover:underline text-xs"
                      >
                        Open booking
                      </Link>
